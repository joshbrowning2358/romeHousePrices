library(rvest)
mainPage = read_html("http://www.immobiliare.it/Roma/agenzie_immobiliari-Roma.html?pag=2")
...
individualAgenzie = read_html("http://www.immobiliare.it/agenzie_immobiliari/Residenze_Roma.html")
